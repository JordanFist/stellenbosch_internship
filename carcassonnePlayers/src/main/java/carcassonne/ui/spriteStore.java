...
public class spriteStore {
	...
	public static final String TILE_LOCATIONS = "../../../resources/main/carcassonne/tiles/";
	public static final String MEEPLE_LOCATIONS = "../../../resources/main/carcassonne/meeples/";
	...
	public void loadTiles() {
		for (int i = 0; i < NUMBER_OF_TILE_SPRITES; ++i)
			loadSprite(TILE_LOCATIONS + "tile" + i + ".jpg");
	}
	
	public void loadMeeples() {
		for (int i = 0; i < NUMBER_OF_MEEPLE_SPRITES; ++i)
			loadSprite(MEEPLE_LOCATIONS + "meeple" + i + ".png");
	}
